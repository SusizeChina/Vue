	...
	<el-row class="tac">
		...
		<el-col :span="24">
			<el-table :data="tableData" height="1000" ref="singleTable" stripe @current-change="currentPage" highlight-current-row tyle="width: 100%">
				...
				<el-table-column prop="RESOURCE_URL" label="API地址" sortable>
				</el-table-column>
				<el-table-column prop="RESOURCE_DESC" label="API描叙" sortable>
				</el-table-column>
				<el-table-column prop="ISTOKEN" label="API分类" sortable>
				</el-table-column>
			</el-table>
		</el-col>
		<el-col :span="24">
	...
	export default {
		...
		methods: {
			...
			getApi() {
				...
				var getHttpUrl = this.Consts.HOST + this.Consts.ADMIN.LIST_API;
